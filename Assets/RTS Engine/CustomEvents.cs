...
namespace RTSEngine
{
	public class CustomEvents : MonoBehaviour {
        ...
        public delegate void RpgEventHandler(stats Rpg);
        public static event RpgEventHandler RpgDeselected = delegate { };
        ...
        public void OnRpgDeselected(stats Rpg)
        {
            if(DebugEnabled == true)
            {
                Debug.Log("Rpg '" + Rpg.Name + "' is deselected");
            }
            RpgDeselected(Rpg);
        }
