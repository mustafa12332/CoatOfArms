...
public class UnitEditor : Editor {
	...
	public override void OnInspectorGUI ()
	{
		...
		EditorGUILayout.Space ();
        Target.redTeamColor = (Material)EditorGUILayout.ObjectField("Red Team", Target.redTeamColor, typeof(Material), false);
        Target.blueTeamColor = (Material)EditorGUILayout.ObjectField("Blue Team", Target.blueTeamColor, typeof(Material), false);
		...
		EditorGUILayout.LabelField ("Main Animator Override Controller:");
